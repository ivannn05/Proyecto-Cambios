...
public class UsuarioServicio {
	...
	public String API_URL_LOGIN = "https://mitienda.iloposa.eu:8081/api/usuarios/login";
	...
	public Usuario getAllUsu(HttpSession session) {
		...
		try {
			...
			String API_URL_SELECT = "https://mitienda.iloposa.eu:8081/api/usuarios/todos"; // Endpoint para obtener todos los
			// usuarios
...
// Convertir la respuesta JSON a lista de usuarios
	...
	public Usuario login(String correo, String contrasena, HttpSession session) {
		...
		try {
			HttpClient client = HttpClient.newHttpClient();
			ObjectMapper objectMapper = new ObjectMapper();
			String API_URL_LOGIN = "https://mitienda.iloposa.eu:8081/api/usuarios/login"; // Endpoint para el login
			String API_URL_SELECT = "https://mitienda.iloposa.eu:8081/api/usuarios/todos"; // Endpoint para obtener todos los
			// usuarios
 ...
 */
	...
	public void enviarCorreoConfirUsu(String correoDestinatario, String asunto, String token)
		...
		String mensaje = "https://mitienda.iloposa.eu/bonsaissur/confirmarUsu?token=";
	...
	public String Post(String nombre, String apellidos, String correo, String direccion, String telefono,
		...
		try {
			HttpClient client = HttpClient.newHttpClient();
			ObjectMapper objectMapper = new ObjectMapper();
			String API_URL = "https://mitienda.iloposa.eu:8081/api/usuarios/crearUsu";
	...
	public String Eliminar(String correo) {
		...
		try {
			...
			HttpClient client = HttpClient.newHttpClient();
			ObjectMapper objectMapper = new ObjectMapper();
			String API_URL_DELETE = "https://mitienda.iloposa.eu:8081/api/usuarios/eliminar"; // Suponiendo que tu API tiene un
	...
	public String Put(String nombre, String apellidos, String correo, String direccion, String telefono) {
		...
		try {
			HttpClient client = HttpClient.newHttpClient();
			ObjectMapper objectMapper = new ObjectMapper();
			String API_URL = "https://mitienda.iloposa.eu:8081/api/usuarios/actualizar";
			String API_URL_SELECT = "https://mitienda.iloposa.eu:8081/api/usuarios/todos";
	...
	public void enviarCorreoToken(String correoDestinatario, String asunto, String token) throws MessagingException {
		Session session = configurarServidorSMTP();
		MimeMessage mimeMessage = new MimeMessage(session);
		String mensaje = "https://mitienda.iloposa.eu/bonsaissur/nuevaContrasena.jsp?token=";
		mimeMessage.setFrom(new InternetAddress(REMITENTE));
		mimeMessage.setRecipients(Message.RecipientType.TO, InternetAddress.parse(correoDestinatario));
		mimeMessage.setSubject(asunto);
		mimeMessage.setText(mensaje + token, "utf-8");
	...
	public String recuperarContrasena(String correoDestinatario) {
		...
		try {
			...
			HttpRequest requestUsu = HttpRequest.newBuilder()
					.uri(URI.create("https://mitienda.iloposa.eu:8081/api/usuarios/todos")).header("Accept", "application/json")
					.GET().build();
